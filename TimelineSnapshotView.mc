    ...
    System.println("times: " + time1 + "," + time2);
       ...
       dc.setColor(Graphics.COLOR_BLACK,Graphics.COLOR_TRANSPARENT);
        ...
        var yes = "no2";
         ...
         if (next.find("hospital") != null || next.find("baby") != null || next.find("appointment") != null || next.find("meds") != null) {
         yes = "yes";
         stefoscope.draw(dc);
         }
         ...
         if (yes == "no")
         { dc.drawText(snapw, snaph+30, Graphics.FONT_SMALL, typetodisplay, Graphics.TEXT_JUSTIFY_CENTER);}
